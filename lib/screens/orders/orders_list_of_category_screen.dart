                                      ...
                                      builder: (BuildContext context) {
                                        return AlertDialog(
                                          ...
                                          content: Column(
                                            ...
                                            children: [
                                              const Text(
                                                'Do you want to cancel or permanently delete this order?',
                                                textAlign: TextAlign.center,
                                                style: TextStyle(fontSize: 13),
                                              ),
                                              const SizedBox(height: 15),
                                              // Cancel order (status -> Cancled)
                                              ElevatedButton(
                                                ...
                                                onPressed: () async {
                                                  // Move the order to the cancelledOrders collection and delete the original
